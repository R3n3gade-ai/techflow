...
def load_historical_data_phase2(start_date: str, end_date: str) -> pd.DataFrame:
    print(f"[DataLoader] Fetching Phase 2 market data from {start_date} to {end_date}...")
    
    # QQQ and SPY for indices, VIX and TNX for macro.
    # GLD for SGOL, BIL for SGOV, DBMF for DBMF, JNK for STRC (Structured Credit proxy).
    # BTC-USD for Crypto/Digital Assets sleeve (20% weight).
    tickers = ["QQQ", "SPY", "^VIX", "^TNX", "GLD", "BIL", "DBMF", "JNK", "BTC-USD"]
